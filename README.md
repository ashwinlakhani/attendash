...
3. In tab "Media Library", create folder named "attendash".
4. Inside folder "attendash", create another two folders named "ProfilePicture" and "FaceGallery".
...
7. Go to GCP console, choose the "attendash" project.
